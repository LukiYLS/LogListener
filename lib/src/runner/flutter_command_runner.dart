...
const String kSnapshotFileName = 'ReplayServerTools.snapshot'; // in //flutter/bin/cache/
const String kFlutterToolsScriptFileName = 'ReplayServerTools.dart'; // in //flutter/packages/ReplayServerTools/bin/
