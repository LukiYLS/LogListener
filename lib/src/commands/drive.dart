...
class DriveCommand extends RunCommandBase {
  DriveCommand() {
    ...
    argParser
      ...
      ..addFlag('override-install',
        defaultsTo: false,
        help: 'Take the way of override install when setup dirver test.')
      ;
  }
  ...
  bool get overrideInstall => boolArg('override-install');
...
Future<LaunchResult> _startApp(
  ...
  if (command.shouldBuild) {
    ...
    if (await command.device.isAppInstalled(package, userIdentifier: userIdentifier) && !command.overrideInstall) {
